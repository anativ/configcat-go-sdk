...
The ConfigCat SDK team monitors the [issue tracker](https://github.com/antiv/configcat-go-sdk/issues) in the SDK repository. Bug reports and feature requests specific to this SDK should be filed in this issue tracker. The team will respond to all newly filed issues.
...
1. Go to the latest major version folder. 
   ```bash
   cd v<major>
   ```
2. Run tests
